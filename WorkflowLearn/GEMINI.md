# WorkflowLearn / Gemini Entrypoint

> 最近确认时间：2026-04-16

## 目的

本文件是 Gemini 在本地 `WorkflowLearn` 仓库中的入口投影副本。
...
7. `_系统/WorkflowLearnSystem/adapters/gemini.md`
...
- Gemini 的本地 hooks、settings、history 和工作区运行态不是共享状态。

## 禁止

- 不要把 `Claude-Learning.md` 当正式规则来源。
- 不要继续使用 slash command、自动 `_snapshot.md`、宿主专属命令作为系统前提。
